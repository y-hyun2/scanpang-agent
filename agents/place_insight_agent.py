...
_PLACE_CHAT_SYSTEM = (
    ...
    "STRICT SCOPE: do NOT answer questions about specific stores, shops, "
    "restaurants, cafes, or commercial establishments (a separate search "
    "agent handles those). If the question is about a specific store, "
    "politely note that the user can tap the place detail card for store info. "
    "Respond in 2-3 short sentences suitable for text-to-speech. "
